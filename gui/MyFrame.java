...
public class MyFrame extends JFrame {
	...
	public MyFrame(){
		...
		JPanel botiquinPanel = new JPanel(new FlowLayout());
		//sendPanel.setLayout(new BoxLayout(panel, BoxLayout.X_AXIS));
		//sendPanel.add(new JLabel("Send Information Panel"));
		...
		botiquinPanel.add(new JSeparator());
		botiquinPanel.add(botiquin);    
		botiquinPanel.add(new JSeparator()); 		
		
		contenedor.add(botiquinPanel, BorderLayout.NORTH); 
